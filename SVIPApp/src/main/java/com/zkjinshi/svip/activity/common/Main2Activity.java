...
public class Main2Activity extends FragmentActivity implements IBeaconObserver {
...
//        slidingMenu.setShadowDrawable(R.drawable.shadow);
            ...
            public void onNetworkResponseSucceed(NetResponse result) {
                ...
                try {
                    ...
                    if(lastOrderInfo != null && !lastOrderInfo.isSet()){
                        ...
                        DialogUtil.getInstance().showToast(Main2Activity.this,"token 过期，请重新登录");
    ...
    private void initListeners() {
        ...
        logoIBtn.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                if (lastOrderInfo != null && lastOrderInfo.getPhone() != null) {
                    IntentUtil.callPhone(Main2Activity.this, lastOrderInfo.getPhone());
                    return true;
                    ...
                    IntentUtil.callPhone(Main2Activity.this, phone);
                    return true;
                }
                return false;
            }
            ...
            public void onClick(View view) {
                ...
                switch (mainTextStatus) {
                    case NO_ORDER_NOT_IN:
                        intent = new Intent(Main2Activity.this, ShopListActivity.class);
                        intent.putExtra("click_to_talk", true);
                        break;
                    default:
                        if (lastOrderInfo != null && lastOrderInfo.getShopid() != null) {
                            intent = new Intent(Main2Activity.this, ChatActivity.class);
                ...
                switch (mainTextStatus) {
                    ...
                    case NO_ORDER_IN:
                        if (svipApplication.mRegionList.size() > 0) {
                            ...
                            intent = new Intent(Main2Activity.this, OrderBookingActivity.class);
                            intent.putExtra("shopid", svipApplication.mRegionList.get(svipApplication.mRegionList.size() - 1).getiBeacon().getShopid());
                        }
                    ...
                    default:
                        if (lastOrderInfo != null && lastOrderInfo.getReservation_no() != null) {
                            intent = new Intent(Main2Activity.this, OrderDetailActivity.class);
        ...
        addLlt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Main2Activity.this, ShopListActivity.class);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right,
                        R.anim.slide_out_left);
            }
