...
public class FastBlur {
	...
	public static void applyBlur(Activity activity,View showView) {
	...
	@SuppressLint("NewApi")
	public static void blur(Bitmap bkg, View view,Activity activity) {
		long startMs = System.currentTimeMillis();
		float scaleFactor = 8;//图片缩放比例；
		float radius = 5;//模糊程度

		Bitmap overlay = Bitmap.createBitmap(
				(int) (DisplayUtil.getWidthPixel(activity) / scaleFactor),
				(int) (DisplayUtil.getHeightPixel(activity) / scaleFactor),
