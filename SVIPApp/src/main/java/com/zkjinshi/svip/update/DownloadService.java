package com.zkjinshi.svip.update;
...
import com.zkjinshi.svip.update.NotificationUpdateActivity.ICallbackResult;
...
public class DownloadService extends Service {
	...
	// private String apkUrl = SVIPApplication.downloadApkUrl;
	/* 下载包安装路径 */
	private static final String savePath = "/sdcard/svip/";

	private static final String saveFileName = savePath + "svip_appUpdate.apk";
	private ICallbackResult callback;
	private DownloadBinder binder;
	private SVIPApplication app;
	...
	public void onCreate() {
		...
		apkUrl = app.updateVo.getPackageurl();
