...
public class GetContactsInfo {
	...
	public String getContactInfo() throws JSONException {
		// 获得通讯录信�? ，URI是ContactsContract.Contacts.CONTENT_URI
		...
		while (cursor.moveToNext()) {
			...
			} else if (mimetype.equals(SipAddress.CONTENT_ITEM_TYPE)) {//互联网�?�话
			...
			/**
			 * 获取电话信息
			 * (手机,单位,住宅,总机,单位传真,住宅传真,寻呼�?,其他,自定�?)
			 */
