...
public class ServerAdapter extends RecyclerView.Adapter<ServerAdapter.ViewHolder> {
    ...
    public ServerAdapter(Activity activity, List<CustomerServiceBean> datas) {
        ...
        this.mOptions = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.drawable.bg_biaoqian)// 设置图片下载期间显示的图片
                .showImageForEmptyUri(R.drawable.bg_biaoqian)// 设置图片Uri为空或是错误的时候显示的图片
                .showImageOnFail(R.drawable.bg_biaoqian)// 设置图片加载或解码过程中发生错误显示的图片
